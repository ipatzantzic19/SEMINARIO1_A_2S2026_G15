...
![Estructura final del bucket](images/15-estructura-final-bucket.jpg)
...
![Permisos finales del bucket](images/16-permisos-finales-bucket.jpg)
...
![Política IAM creada](images/17-politica-iam-final.jpg)
...
![Revisión del rol de Node.js](images/18-revision-rol-node.jpg)

![Revisión del rol de Python](images/19-revision-rol-python.jpg)

![Roles IAM creados](images/20-roles-iam-creados.jpg)
...
![Carga de prueba exitosa](images/21-carga-sdk-cli-exitosa.jpg)

![Objeto en Fotos_Perfil](images/22-objeto-fotos-perfil.jpg)

![Objeto en Fotos_Peliculas](images/25-objeto-fotos-peliculas.jpg)
...
![Validación HTTP 200 de ambas URLs](images/24-validacion-urls-200.jpg)
...
![Pantalla de carga de objetos](images/14-carga-imagen-pendiente.jpg)
