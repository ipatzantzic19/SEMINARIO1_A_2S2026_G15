...
![Formulario del security group](images/03-security-group-formulario.jpg)
...
![Security group sin entradas](images/04-security-group-sin-entradas.jpg)
...
![Security group creado](images/05-security-group-creado.jpg)
...
![Motor y método de creación](images/06-motor-y-metodo.jpg)
...
![Plantilla y disponibilidad](images/07-plantilla-y-disponibilidad.jpg)
...
![Identificador y credenciales](images/08-identificador-y-credenciales.jpg)
...
![Clase y almacenamiento](images/09-clase-y-almacenamiento.jpg)
...
![Conectividad privada](images/10-conectividad-privada.jpg)
...
![Supervisión](images/11-supervision.jpg)
...
![Configuración adicional](images/12-configuracion-adicional.jpg)
...
![Etiquetas](images/13-etiquetas.jpg)
...
![Revisión antes de crear](images/14-revision-antes-de-crear.jpg)
...
![RDS en creación](images/15-rds-en-creacion.jpg)
...
![RDS disponible](images/16-rds-disponible.jpg)
...
![Configuración final](images/17-configuracion-final.jpg)
...
![Almacenamiento y protección final](images/17b-almacenamiento-proteccion-final.jpg)
...
![Conectividad final](images/18-conectividad-final.jpg)

### 13.4 Respaldos

Se verifica que los respaldos automatizados están habilitados con una retención de un día.

![Respaldos finales](images/19-respaldos-finales.jpg)
...
![Security group final](images/20-security-group-final.jpg)
...
![Formulario del security group temporal](images/21-security-group-cloudshell-formulario.jpg)

![Reglas del security group temporal](images/22-security-group-cloudshell-reglas.jpg)

![Security group temporal creado](images/23-security-group-cloudshell-creado.jpg)
...
![Regla temporal de RDS](images/24-regla-rds-desde-cloudshell.jpg)

![Regla temporal guardada](images/25-regla-rds-cloudshell-guardada.jpg)
...
![Formulario del entorno CloudShell VPC](images/26-cloudshell-vpc-formulario.jpg)

![Entorno CloudShell VPC en creación](images/27-cloudshell-vpc-creando.jpg)

![Entorno CloudShell VPC listo](images/28-cloudshell-vpc-listo.jpg)
...
![Solicitud de contraseña de PostgreSQL](images/29-psql-solicita-contrasena.jpg)
...
![Resultado inicial de la verificación](images/30-verificacion-conteo-triggers.jpg)
...
![Verificación exitosa de RDS](images/31-verificacion-rds-exitosa.jpg)
...
![RDS privado después de retirar el acceso temporal](images/32-rds-sin-entradas-post-schema.jpg)
...
Las capturas numeradas `00`, `01`, `02` y `02b` se mantienen en `docs/evidence/images/` como material complementario de auditoría. La secuencia de implementación documentada comienza en la captura `03`, que corresponde a la creación del security group.
